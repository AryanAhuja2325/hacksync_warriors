// Instagram insights view removed from the UI
export default function InstagramInsights() { return null; }
  return (
    <div
      style={{
        minHeight: "100vh",
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          backgroundImage:
            "radial-gradient(1px 1px at 20% 20%, #ffffff33 0, transparent 60%), radial-gradient(1px 1px at 80% 30%, #ffffff22 0, transparent 60%)",
          opacity: 0.4,
          zIndex: 0,
        }}
      />
